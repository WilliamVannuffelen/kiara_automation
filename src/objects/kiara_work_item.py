...
class KiaraWorkItem:
    def __init__(self, day=None, date="", description = "", jira_ref: Optional[str] = None, time_spent:Optional[float] = None, project: Optional[str] = None, app_ref: Optional[str] = None):
        self.day = day
        self.date = date
